...
- **발행자**: `e0509_jointpos_with_gripper_ros2.py`
...
- **구독자**: 
  - `joint_state_bridge_with_gripper.py` (Isaac Sim 전달용)
  - `e0509_jointpos_with_gripper_ros2.py` (직접 제어용)
- **데이터 구조**:
  ```python
  {
...
### 4. `/joint_input` ✅
- **타입**: `std_msgs/Float32MultiArray`
- **발행자**: `joint_state_bridge_with_gripper.py`
- **구독자**: `e0509_jointpos_with_gripper_ros2.py`
- **데이터 구조**:
  ```python
  {
    'data': [
