...
class E0509PickPlaceEnvCfg(joint_pos_env_cfg.E0509PickPlaceEnvCfg):
    def __post_init__(self):
        ...
        # Set actions for the specific robot type (E0509) with absolute IK control
        self.actions.arm_action = DifferentialInverseKinematicsActionCfg(
            ...
            scale=1.0,
            body_offset=DifferentialInverseKinematicsActionCfg.OffsetCfg(pos=[0.0, 0.0, 0.1]),  # E0509 TCP offset
        )
